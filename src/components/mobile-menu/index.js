...
function Index() {
  ...
  return (
    <div className="h-screen grid grid-cols-1  p-1">
      {/* Menu */}
      <div
        // style={{ height: window.screen.availHeight - 0, overflow: "scroll" }}
        className="pt-6  px-5 py-5 pb-60  shadow-lg bg-white h-screen overflow-scroll "
      >
              ...
              <div className="grid grid-cols-1 gap-y-10 mt-5">
                {data.categories.map((category) => (
                  <div className="grid grid-cols-1 gap-y-2">
                    <h1 className="text-sm uppercase text-black font-medium pb-3">
                      {category.name}
                    </h1>
                  </div>
                ))}
